    ...
    for (var i = 1; i <= 3; i++) {
        $(description_pop_in + String(i)).click(function () {
            if (this.id == "description_pop_in_1") {
                $(".pad_left_pop_in").html("<div style='padding-top: 6px'></div><span class='vert_code'>La prison est souvent facteur d'isolement voir d'exclusion de notre                    société.</span> Au sein de nos centres d'hébergement, nous accueillons les personnes                sortant de prison ou encore sous main de justice pour leur éviter la rue et la dérive sociale,                voire la récidive. Offrir un toit, un repas chaud, rompre la solitude en échangeant avec nos                équipes, tout cela constitue les premières bases de notre accueil.<div style='padding-top: 6px'></div><div style='padding-top: 6px'></div>                De plus, chaque personne accueillie est suivie par un travailleur social, qui devient son                référent tout au long se son parcours avec l'Îlot. Avec lui, elle élabore un projet                individualisé en abordant toutes les dimensions sociales nécessaires à la réinsertion (rétablir                les droits sociaux, retisser les liens familiaux, prendre en charge sa santé, etc.). Tout ce                parcours au sein de notre association se fait en valorisant la personne accompagnée afin de lui                permettre de prendre un nouveau départ et de devenir actrice de sa vie.                <div style='padding-top: 6px'></div><div style='padding-top: 6px'></div>");
            ...
            if (this.id == "description_pop_in_3") {
                $(".pad_left_pop_in").html("<div style='padding-top: 6px'></div><span class='vert_code'>Reprendre confiance en soi, développer des savoir-faire concrets et des savoir-être en entreprise,</span> nos chantiers d’Insertion par l’Activité Économique (IAE) et notre formation Atelier Qualification-Insertion (AQI) permettent aux personnes sortant de prison ou encore sous main de justice de trouver une place sur le marché de l’emploi ou d’obtenir un diplôme reconnu par l’Etat.<div style='padding-top: 6px'></div><div style='padding-top: 6px'></div>Encadrées par un conseiller en insertion professionnelle, chacune d’entre elle bâtit son projet professionnel car l’un des facteurs de réussite de la réinsertion reste l’emploi. En fonction de leurs besoins, elles participent également à des ateliers collectifs complémentaires (remise à niveau des savoirs de base, informatique, gestion de budget personnel, aide à la recherche d'emploi, etc.).<div style='padding-top: 6px'></div><div style='padding-top: 6px'></div>En 2018, 40% des salariés en insertion dans nos Ateliers ont trouvé un emploi ou une formation à la suite de leur passage à l’Îlot. Et 48% des personnes qui ont suivies la formation Atelier Qualification - Insertion ont été embauchées à la suite de leur diplôme.<div style='padding-top: 6px'></div><div style='padding-top: 6px'></div>");
