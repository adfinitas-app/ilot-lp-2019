    ...
    for (var i = 1; i <= 3; i++) {
        $(description_pop_in + String(i)).click(function () {
            if (this.id == "description_pop_in_1") {
                ...
                $("#link_don_pop-in").attr("href", "https://donner.ilot.asso.fr/b?cid=30&amount=6000&frequency=once&utm_medium=organic&utm_source=landingpage&utm_campaign=fa2020&utm_content=accueillir&reserved_code=20WFALP");
            }
            ...
            if (this.id == "description_pop_in_3") {
                ...
                $("#pop_in_div").css({
                    backgroundImage: "url(assets/pop_in_2.jpg)",
                    backgroundPosition: "0 -40px"
                });
                $("#div_change_bg_pop_in").css("background-color", "rgba(255, 255, 255, 0.95)");
                $("#link_don_pop-in").attr("href", "https://donner.ilot.asso.fr/b?cid=30&amount=17000&frequency=once&utm_medium=organic&utm_source=landingpage&utm_campaign=fa2020&utm_content=emploi&reserved_code=20WFALP");
            }
